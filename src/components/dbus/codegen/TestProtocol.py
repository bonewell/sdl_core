...
class TestProtocol(TestCase):
    ...
    def test_signal_load(self):
        a = Adapter()
        p1 = Mock(); p1.type = 'Float'
        p2 = Mock(); p2.type = 'Integer'
        p3 = Mock(); p3.type = 'String'
        a.functionParameters = Mock(return_value=[p1, p2, p3])
        s = Signal(a, None)
        s.load()
    ...
    def test_method_load(self):
        a = Adapter()
        pi1 = Mock(); pi1.type = 'Float'
        pi2 = Mock(); pi2.type = 'Integer'
        pi3 = Mock(); pi3.type = 'Boolean'
        po1 = Mock(); po1.type = 'String'
        po2 = Mock(); po2.type = 'Double'
        a.functionParameters = Mock(side_effect=[[pi1, pi2, pi3], [po1, po2]])
